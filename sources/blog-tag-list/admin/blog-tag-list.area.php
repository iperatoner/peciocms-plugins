            ...
            if (isset($_POST['list_wrapper_template']) && isset($_POST['list_element_template'])) {
                if (file_put_contents(
                    ...
                    $messages .= PecMessageHandler::custom(
                        'Saved templates', 
                        'You have successfully saved the blog tag list templates.',
                        MESSAGE_INFO
                    );
                }
                else {
...
function view_default() {  
    ...
    $area_data = array();
    $area_data['title'] = 'Blog Tag List';
    $area_data['content'] = '
            With this plugin you can list all your blog tags anywhere on the website.<br /><br />
